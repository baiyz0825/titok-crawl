...
**本项目仅供学习研究使用，严禁用于任何商业或非法用途！**

### 📌 重要提示

1. **学习目的**
   - 本项目仅用于学习浏览器自动化、数据采集等技术
   - 不得用于任何商业用途或盈利目的
   - 不得用于大规模数据爬取或恶意请求

2. **法律合规**
   - 使用本项目必须遵守《中华人民共和国网络安全法》等相关法律法规
   - 不得采集、存储、传播任何违法违规内容
   - 不得侵犯他人隐私、知识产权等合法权益
   - 不得对目标网站造成任何形式的损害或负担
...
3. **风险承担**
   ...
   - 项目作者不承担任何因使用本项目而产生的法律责任
   - 使用者需自行评估并承担所有风险

4. **使用限制**
   - 不得绕过网站的反爬机制进行恶意采集
   - 不得泄露、出售或非法使用采集的数据
   - 必须遵守目标网站的 robots.txt 和服务条款
   - 建议设置合理的请求频率，避免对服务器造成压力

5. **数据安全**
   - 采集的个人数据必须妥善保管，不得泄露
   - 必须遵守相关数据保护法规（如《个人信息保护法》）
   - 不得将数据用于任何可能危害国家安全或社会稳定的目的
...
**使用本项目即表示您已阅读、理解并同意遵守以上免责声明。如果您不同意，请勿使用本项目。**
